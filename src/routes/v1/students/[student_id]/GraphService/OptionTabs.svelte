...
<section class="flex justify-between text-[#445569] bg-gray-200 border-b-2 border-gray-200 absolute left-0 right-0 top-0 z-[9999] rounded-tl-xl rounded-tr-xl">
